...
const Registration = () => {
  const {setRegisteredUser, registeredUser, player, generateNewAvatar, setPassword, showAlert} = useContext(QuizContext);
  ...
  return (
      <>
      {showAlert ?
              <div className="quiz__overlay__alert">Nieprawidłowe hasło.</div>
              :
